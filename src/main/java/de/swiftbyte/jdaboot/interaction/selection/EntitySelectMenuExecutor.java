...
/**
 * The EntitySelectMenuExecutor class represents an entity select menu in the application.
 * It provides a method to handle entity select menu submit events.
 *
 * @since 1.0.0-alpha.11
 */
public abstract class EntitySelectMenuExecutor {
     ...
     * @since 1.0.0-alpha.11
     */
    public abstract void onSelectMenuSubmit(@NonNull EntitySelectInteractionEvent event, @NonNull Map<@NonNull String, @NonNull String> variables);
     ...
     * @since 1.0.0-beta.2
     */
    protected void reply(@NonNull EntitySelectInteractionEvent event, @NonNull TemplateEmbed embed) {
     ...
     * @since 1.0.0-beta.2
     */
    protected void reply(@NonNull EntitySelectInteractionEvent event, @NonNull TemplateEmbed embed, @NonNull DiscordLocale locale) {
     ...
     * @since 1.0.0-beta.2
     */
    protected void reply(@NonNull EntitySelectInteractionEvent event, @NonNull TemplateComponentV2 component) {
     ...
     * @since 1.0.0-beta.2
     */
    protected void reply(@NonNull EntitySelectInteractionEvent event, @NonNull TemplateComponentV2 component, @NonNull DiscordLocale locale) {
     ...
     * @since 1.0.0-beta.2
     */
    protected void reply(@NonNull EntitySelectInteractionEvent event, @NonNull TemplateModal modal) {
     ...
     * @since 1.0.0-beta.2
     */
    protected void reply(@NonNull EntitySelectInteractionEvent event, @NonNull TemplateModal modal, @NonNull DiscordLocale locale) {
     ...
     * @since 1.0.0-beta.2
     */
    protected void replyEphemeral(@NonNull EntitySelectInteractionEvent event, @NonNull TemplateEmbed embed) {
     ...
     * @since 1.0.0-beta.2
     */
    protected void replyEphemeral(@NonNull EntitySelectInteractionEvent event, @NonNull TemplateEmbed embed, @NonNull DiscordLocale locale) {
     ...
     * @since 1.0.0-beta.2
     */
    protected void replyEphemeral(@NonNull EntitySelectInteractionEvent event, @NonNull TemplateComponentV2 component) {
     ...
     * @since 1.0.0-beta.2
     */
    protected void replyEphemeral(@NonNull EntitySelectInteractionEvent event, @NonNull TemplateComponentV2 component, @NonNull DiscordLocale locale) {
